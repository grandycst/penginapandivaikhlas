				...
				<div class="row">
					...
					<div class="col-sm-5">
						<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-6">
									<select class="form-control" name="jumlah_dewasa"required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
						...
						<div class="form-group">
							<label>Jumlah Discount (Rp)</label>
							<input class="form-control" name="disc" required />
						</div>
						<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-6">
									<select class="form-control" name="jaminan">
										<option value="jaminan">- Pilih Jaminan -</option>
										<option value="KTP">KTP/SIM/PASSPORT</option>
